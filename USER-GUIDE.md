...
Wholesale / RRP** multipliers, and **Final pH**. (The **Method** — a WYSIWYG rich-text
editor, saved as HTML and shown on the batch sheet — lives in the **Formula Ingredients
& Method** box, beneath the ingredients table.)
